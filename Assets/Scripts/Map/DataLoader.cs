...
public class DataLoader : MonoBehaviour {
    ...
    private const string KEY_FRISTTIME = "one"; //key check first app to play
    ...
    void insmap(Vector3 pos, int index)
    {
        ...
        tmp.transform.SetParent(mapParent.transform,false);  //注意是相对父物体的坐标系，不是世界坐标系
        listmap[index] = tmp;
    ...
    void StarPointMove()
    {
        ...
        Util.MoveTo(CameraMovement.mcamera.StarPoint, newpos, STARMOVE_TIME, newpos.z);
